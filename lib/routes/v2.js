...
exports.subscriptions = {
  ...
  postpone: [
    '/v2/subscriptions/:uuid/postpone?next_renewal_date=:next_renewal_date',
    'PUT',
  ],
};
...
exports.usage = {
  list: [
    '/v2/subscriptions/:uuid/add_ons/:add_on_code/usage?billing_status=:billing_status',
    'GET',
  ],
  log: ['/v2/subscriptions/:uuid/add_ons/:add_on_code/usage', 'POST'],
  get: ['/v2/subscriptions/:uuid/add_ons/:add_on_code/usage/:usage_id', 'GET'],
  update: [
    '/v2/subscriptions/:uuid/add_ons/:add_on_code/usage/:usage_id',
    'PUT',
  ],
  remove: [
    '/v2/subscriptions/:uuid/add_ons/:add_on_code/usage/:usage_id',
...
exports.shippingAdress = {
  create: ['/v2/accounts/:account_code/shipping_addresses', 'POST'],
  update: [
    '/v2/accounts/:account_code/shipping_addresses/:shipping_address_id',
    'PUT',
  ],
  listByAccount: ['/v2/accounts/:account_code/shipping_addresses', 'GET'],
  get: [
    '/v2/accounts/:account_code/shipping_addresses/:shipping_address_id',
    'GET',
  ],
